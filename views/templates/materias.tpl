...
{block name=content}
    ...
    <div class="px-4 mt-6 sm:px-6 lg:px-8">
        <h2 class="text-gray-500 text-xs font-medium uppercase tracking-wide">Materias registradas</h2>
                  ...
                  <div x-data="{ isOpen: false }" class="flex-shrink-0 pr-2">
                    ...
                    <div
                      ...
                      <div class="py-1" role="none">
                        <a href="/materias/editar?id={$materia->id}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Editar</a>
                      </div>
                      <div class="py-1 relative overflow-hidden" role="none"
                        ...
                        <div x-show="showModal" class="fixed z-10 inset-0 overflow-y-auto"  :class="{ '': showModal }" aria-labelledby="dialog-1-title" role="dialog" aria-modal="true">
